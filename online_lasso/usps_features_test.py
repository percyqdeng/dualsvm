...
plt.subplot(222)
plt.plot(rgr.num_features, rgr.test_obj, 'bo-', label='scg')
plt.plot(rgr2.num_features, rgr2.test_obj, 'gd-', label='rda')
plt.plot(rgr3.num_features, rgr3.test_obj, 'r>-', label='cd')
plt.plot(rgr4.num_features, rgr4.test_obj, 'mD-', label='rda2')
plt.xlabel('number of features')
plt.ticklabel_format(style='sci', axis='x', scilimits=(0,0))
plt.ylabel('test obj')
# plt.figure()
