...
class Pegasos(MySVM):
    ...
    def __init__(self, lmda=0.01, gm=1, kernelstr='rbf', verbose=True, nsweep=4, batchsize=1):
        super(Pegasos, self).__init__(lmda=lmda, gm=gm, kernelstr=kernelstr, nsweep=nsweep, b=5, c=1)
