/* Generated by Cython 0.20.1 on Mon Aug 11 17:27:35 2014 */
...
static PyObject *__pyx_pw_12online_lasso_9scg_lasso_1train(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("train (wrapper)", 0);
  {
    ...
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1]); if (unlikely(!__pyx_v_y.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
    ...
    if (values[3]) {
      __pyx_v_ytest = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3]); if (unlikely(!__pyx_v_ytest.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
