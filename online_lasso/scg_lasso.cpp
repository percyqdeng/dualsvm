/* Generated by Cython 0.20.2 on Fri Aug 15 15:26:42 2014 */
...
/* "online_lasso/scg_lasso.pyx":222
 * 
 * 
...
static PyObject *__pyx_pf_12online_lasso_9scg_lasso_train(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_xtest, __Pyx_memviewslice __pyx_v_ytest, int __pyx_v_b, int __pyx_v_c, double __pyx_v_lmda, double __pyx_v_sig_D, int __pyx_v_verbosity, Py_ssize_t __pyx_v_T); /* proto */
...
static char __pyx_k_sqnorm_w[] = "sqnorm_w";
...
static PyObject *__pyx_n_s_sqnorm_w;
...
static PyObject *__pyx_pw_12online_lasso_9scg_lasso_1train(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_y,&__pyx_n_s_xtest,&__pyx_n_s_ytest,&__pyx_n_s_b,&__pyx_n_s_c,&__pyx_n_s_lmda,&__pyx_n_s_sig_D,&__pyx_n_s_verbosity,&__pyx_n_s_T,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("train", 0, 2, 10, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "train") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0]); if (unlikely(!__pyx_v_x.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1]); if (unlikely(!__pyx_v_y.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_xtest = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[2]); if (unlikely(!__pyx_v_xtest.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_xtest = __pyx_k_;
      __PYX_INC_MEMVIEW(&__pyx_v_xtest, 1);
    }
    if (values[3]) {
      __pyx_v_ytest = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3]); if (unlikely(!__pyx_v_ytest.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_ytest = __pyx_k__2;
      __PYX_INC_MEMVIEW(&__pyx_v_ytest, 1);
    }
    if (values[4]) {
      __pyx_v_b = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_b == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_b = ((int)4);
    }
    if (values[5]) {
      __pyx_v_c = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_c == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_c = ((int)1);
    }
    if (values[6]) {
      __pyx_v_lmda = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_lmda == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_lmda = ((double)0.1);
    }
    if (values[7]) {
      __pyx_v_sig_D = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_sig_D == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_sig_D = ((double)-1.0);
    }
    if (values[8]) {
      __pyx_v_verbosity = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_verbosity == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {

      /* "online_lasso/scg_lasso.pyx":55
 * @cython.wraparound(False)
 * def train(double [:,::1] x, double[::1]y, double[:,::1]xtest=None, double[::1]ytest=None,
 *           int b=4, int c=1, double lmda=0.1, double sig_D=-1, int verbosity=True, Py_ssize_t T=1000):             # <<<<<<<<<<<<<<
 *     """
 ...
 */
    ...
    if (values[9]) {
      __pyx_v_T = __Pyx_PyIndex_AsSsize_t(values[9]); if (unlikely((__pyx_v_T == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("train", 0, 2, 10, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("online_lasso.scg_lasso.train", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12online_lasso_9scg_lasso_train(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_xtest, __pyx_v_ytest, __pyx_v_b, __pyx_v_c, __pyx_v_lmda, __pyx_v_sig_D, __pyx_v_verbosity, __pyx_v_T);
...
static PyObject *__pyx_pf_12online_lasso_9scg_lasso_train(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_xtest, __Pyx_memviewslice __pyx_v_ytest, int __pyx_v_b, int __pyx_v_c, double __pyx_v_lmda, double __pyx_v_sig_D, int __pyx_v_verbosity, Py_ssize_t __pyx_v_T) {
  ...
  std::vector<double> __pyx_v_sqnorm_w;
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_c); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_intp); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_6, __pyx_t_4); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_b); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_intp); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_7) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_zeros); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_intp); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_zeros); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_6, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_5);
  if (unlikely(!__pyx_t_12.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_ones); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_intc); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_7, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dc_int(__pyx_t_4);
  if (unlikely(!__pyx_t_13.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GIVEREF(__pyx_t_4);
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_7, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GIVEREF(__pyx_t_4);
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_4);
  if (unlikely(!__pyx_t_15.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GIVEREF(__pyx_t_4);
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_7, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_4);
  if (unlikely(!__pyx_t_16.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GIVEREF(__pyx_t_4);
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_17 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_4);
  if (unlikely(!__pyx_t_17.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_g_tilde = __pyx_t_17;
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "online_lasso/scg_lasso.pyx":101
 * 
 *     if not verbosity:
 *         interval = T             # <<<<<<<<<<<<<<
 *     cdef double tmp, tmp2, xw
 *     if sig_D < 0:
 */
    __pyx_v_interval = __pyx_v_T;
    goto __pyx_L4;
  }
  __pyx_L4:;

  /* "online_lasso/scg_lasso.pyx":103
 *         interval = T
 *     cdef double tmp, tmp2, xw
 *     if sig_D < 0:             # <<<<<<<<<<<<<<
 *         sig = np.sqrt(p**3/c)
 *         D = np.sqrt(p * 1)
 */
  __pyx_t_3 = ((__pyx_v_sig_D < 0.0) != 0);
  if (__pyx_t_3) {

    /* "online_lasso/scg_lasso.pyx":104
 *     cdef double tmp, tmp2, xw
 *     if sig_D < 0:
 *         sig = np.sqrt(p**3/c)             # <<<<<<<<<<<<<<
 *         D = np.sqrt(p * 1)
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyInt_FromSsize_t((__Pyx_pow_Py_ssize_t(__pyx_v_p, 3) / __pyx_v_c)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_v_sig = __pyx_t_18;

    /* "online_lasso/scg_lasso.pyx":105
 *     if sig_D < 0:
 *         sig = np.sqrt(p**3/c)
 *         D = np.sqrt(p * 1)             # <<<<<<<<<<<<<<
 *         sig_D = sig / D
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyInt_FromSsize_t((__pyx_v_p * 1)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __Pyx_GIVEREF(__pyx_t_4);
    __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_v_D = __pyx_t_18;

    /* "online_lasso/scg_lasso.pyx":106
 *         sig = np.sqrt(p**3/c)
 *         D = np.sqrt(p * 1)
 *         sig_D = sig / D             # <<<<<<<<<<<<<<
 *     gm = fmax(2*c, np.sqrt(2.0*b*(T+1.0)/p)* sig_D)
 *     # print "---------------------scg lasso-------------------\n" \
 */
    __pyx_v_sig_D = (__pyx_v_sig / __pyx_v_D);
    goto __pyx_L5;
  }
  __pyx_L5:;

  /* "online_lasso/scg_lasso.pyx":107
 *         D = np.sqrt(p * 1)
 *         sig_D = sig / D
 *     gm = fmax(2*c, np.sqrt(2.0*b*(T+1.0)/p)* sig_D)             # <<<<<<<<<<<<<<
 *     # print "---------------------scg lasso-------------------\n" \
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyFloat_FromDouble((((2.0 * __pyx_v_b) * (__pyx_v_T + 1.0)) / __pyx_v_p)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = PyFloat_FromDouble(__pyx_v_sig_D); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_5 = PyNumber_Multiply(__pyx_t_4, __pyx_t_7); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_gm = fmax((2 * __pyx_v_c), __pyx_t_18);

  /* "online_lasso/scg_lasso.pyx":110
 *     # print "---------------------scg lasso-------------------\n" \
 *     #       "lamda %f, gamma %f, b:%d, c:%d" % (lmda, gm, b, c)
 *     r1 = RandNoRep(p)             # <<<<<<<<<<<<<<
 *     r2 = RandNoRep(p)
 *     start_t = clock()
 */
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GIVEREF(__pyx_t_5);
  __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_12online_lasso_9scg_lasso_RandNoRep)), __pyx_t_7, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_r1 = ((struct __pyx_obj_12online_lasso_9scg_lasso_RandNoRep *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "online_lasso/scg_lasso.pyx":111
 *     #       "lamda %f, gamma %f, b:%d, c:%d" % (lmda, gm, b, c)
 *     r1 = RandNoRep(p)
 *     r2 = RandNoRep(p)             # <<<<<<<<<<<<<<
 *     start_t = clock()
 *     for t in xrange(T+1):
 */
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GIVEREF(__pyx_t_5);
  __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_12online_lasso_9scg_lasso_RandNoRep)), __pyx_t_7, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_r2 = ((struct __pyx_obj_12online_lasso_9scg_lasso_RandNoRep *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "online_lasso/scg_lasso.pyx":112
 *     r1 = RandNoRep(p)
 *     r2 = RandNoRep(p)
 *     start_t = clock()             # <<<<<<<<<<<<<<
 *     for t in xrange(T+1):
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":113
 *     r2 = RandNoRep(p)
 *     start_t = clock()
 *     for t in xrange(T+1):             # <<<<<<<<<<<<<<
 *         ind = rand() % n
 ...
 *         xw = 0
 */
    __pyx_t_5 = ((struct __pyx_vtabstruct_12online_lasso_9scg_lasso_RandNoRep *)__pyx_v_r1->__pyx_vtab)->k_choice(__pyx_v_r1, __pyx_v_I, __pyx_v_c); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *         for i in xrange(c):
 */
    __pyx_t_5 = ((struct __pyx_vtabstruct_12online_lasso_9scg_lasso_RandNoRep *)__pyx_v_r2->__pyx_vtab)->k_choice(__pyx_v_r2, __pyx_v_J, __pyx_v_b); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
      ...
      __pyx_v_xw = (__pyx_v_xw + ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_24 * __pyx_v_x.strides[0]) )) + __pyx_t_25)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_27)) )))));
    }
 ...
 */
      ...
      __pyx_v_cur_grad = ((((__pyx_v_xw * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_29 * __pyx_v_x.strides[0]) )) + __pyx_t_30)) )))) * __pyx_v_p) / __pyx_v_c) - ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_31)) ))) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_33 * __pyx_v_x.strides[0]) )) + __pyx_t_34)) )))));
 ...
 */
      ...
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_g_tilde.data) + __pyx_t_36)) )) += __pyx_v_cur_grad;
 ...
 */
      ...
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_l.data) + __pyx_t_44)) )) += __pyx_v_lmda;
      ...
      /* "online_lasso/scg_lasso.pyx":125
 *             w_tilde[J[j]] += (t+1 - u[J[j]]) * w[J[j]]
 *             l[J[j]] += lmda
 *             tmp2 = fabs(g_tilde[J[j]])             # <<<<<<<<<<<<<<
 *             flag[J[j]] = (tmp2<=l[J[j]])
 ...
 */
      ...
      __pyx_v_tmp2 = fabs((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_g_tilde.data) + __pyx_t_46)) ))));
 ...
 */
      ...
      *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_flag.data) + __pyx_t_50)) )) = (__pyx_v_tmp2 <= (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_l.data) + __pyx_t_48)) ))));
      ...
      /* "online_lasso/scg_lasso.pyx":127
 *             tmp2 = fabs(g_tilde[J[j]])
 *             flag[J[j]] = (tmp2<=l[J[j]])
 *             w[J[j]] = - sign_func(g_tilde[J[j]]) * fmax(tmp2-l[J[j]], 0) / gm             # <<<<<<<<<<<<<<
 *             u[J[j]] = t + 1
 ...
 */
      ...
      __pyx_t_5 = __pyx_f_12online_lasso_9scg_lasso_sign_func((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_g_tilde.data) + __pyx_t_52)) )))); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_7 = PyNumber_Negative(__pyx_t_5); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_53 = __pyx_v_j;
      __pyx_t_54 = (*((Py_ssize_t *) ( /* dim=0 */ ((char *) (((Py_ssize_t *) __pyx_v_J.data) + __pyx_t_53)) )));
      __pyx_t_5 = PyFloat_FromDouble(fmax((__pyx_v_tmp2 - (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_l.data) + __pyx_t_54)) )))), 0.0)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = PyNumber_Multiply(__pyx_t_7, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyFloat_FromDouble(__pyx_v_gm); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_7 = __Pyx_PyNumber_Divide(__pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      ...
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_56)) )) = __pyx_t_18;
      ...
      /* "online_lasso/scg_lasso.pyx":128
 *             flag[J[j]] = (tmp2<=l[J[j]])
 *             w[J[j]] = - sign_func(g_tilde[J[j]]) * fmax(tmp2-l[J[j]], 0) / gm
 *             u[J[j]] = t + 1             # <<<<<<<<<<<<<<
 *         if num_steps == t:
 ...
 */
    ...
    /* "online_lasso/scg_lasso.pyx":129
 *             w[J[j]] = - sign_func(g_tilde[J[j]]) * fmax(tmp2-l[J[j]], 0) / gm
 *             u[J[j]] = t + 1
 *         if num_steps == t:             # <<<<<<<<<<<<<<
 *             end_t = clock()
 ...
 */
    __pyx_t_3 = ((__pyx_v_num_steps == __pyx_v_t) != 0);
    if (__pyx_t_3) {

      /* "online_lasso/scg_lasso.pyx":130
 *             u[J[j]] = t + 1
 *         if num_steps == t:
 *             end_t = clock()             # <<<<<<<<<<<<<<
 *             cpu_t += <double>(end_t - start_t) / CLOCKS_PER_SEC
 ...
 */
      ...
      /* "online_lasso/scg_lasso.pyx":131
 *         if num_steps == t:
 *             end_t = clock()
 *             cpu_t += <double>(end_t - start_t) / CLOCKS_PER_SEC             # <<<<<<<<<<<<<<
 *             # print <double>(end_t - start_t) / CLOCKS_PER_SEC
 ...
 */
      ...
      /* "online_lasso/scg_lasso.pyx":133
 *             cpu_t += <double>(end_t - start_t) / CLOCKS_PER_SEC
 *             # print <double>(end_t - start_t) / CLOCKS_PER_SEC
 *             timecost.push_back(cpu_t)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "online_lasso/scg_lasso.pyx":136
 *             # compute train error, # of zeros
 *             num_iters.push_back(t)
 *             num_features.push_back((t+1) * (b+c))             # <<<<<<<<<<<<<<
 *             train_res.push_back(eval_lasso_obj(w, x, y, lmda))
 ...
 */
      ...
      /* "online_lasso/scg_lasso.pyx":137
 *             num_iters.push_back(t)
 *             num_features.push_back((t+1) * (b+c))
 *             train_res.push_back(eval_lasso_obj(w, x, y, lmda))             # <<<<<<<<<<<<<<
 *             # interval *= 2
 *             num_steps += interval
 */
      __pyx_t_7 = __pyx_f_12online_lasso_9scg_lasso_eval_lasso_obj(__pyx_v_w, __pyx_v_x, __pyx_v_y, __pyx_v_lmda); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 *             tmp = 0
 */
        __pyx_t_7 = __pyx_f_12online_lasso_9scg_lasso_eval_lasso_obj(__pyx_v_w, __pyx_v_xtest, __pyx_v_ytest, __pyx_v_lmda); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_v_test_res.push_back(__pyx_t_18);
        goto __pyx_L13;
      }
      __pyx_L13:;
 ...
 */
        ...
        __pyx_v_tmp = (__pyx_v_tmp + ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_61)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_62)) )))));
      }
 ...
 *             start_t = clock()
 */
      __pyx_v_sqnorm_w.push_back(__pyx_v_tmp);
 ...
 */
    ...
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w_bar.data) + __pyx_t_64)) )) = (((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w_tilde.data) + __pyx_t_22)) ))) + (((__pyx_v_T + 2) - (*((Py_ssize_t *) ( /* dim=0 */ ((char *) (((Py_ssize_t *) __pyx_v_u.data) + __pyx_t_59)) )))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_63)) ))))) / (__pyx_v_T + 1));
  }
 ...
 *     else:
 */
  __pyx_t_3 = ((!(__pyx_v_has_test != 0)) != 0);
  if (__pyx_t_3) {
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_asarray); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = __pyx_memoryview_fromslice(__pyx_v_w_bar, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    ...
    __Pyx_GIVEREF(__pyx_t_7);
    __pyx_t_7 = 0;
    __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __pyx_convert_vector_to_py_double(__pyx_v_train_res); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __pyx_convert_vector_to_py_double(__pyx_v_num_zs); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = __pyx_convert_vector_to_py_double(__pyx_v_num_iters); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = __pyx_convert_vector_to_py_double(__pyx_v_num_features); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_65 = __pyx_convert_vector_to_py_double(__pyx_v_sqnorm_w); if (unlikely(!__pyx_t_65)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_65);
    __pyx_t_66 = __pyx_convert_vector_to_py_double(__pyx_v_timecost); if (unlikely(!__pyx_t_66)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_66);
    __pyx_t_67 = PyTuple_New(7); if (unlikely(!__pyx_t_67)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_67);
    PyTuple_SET_ITEM(__pyx_t_67, 0, __pyx_t_7);
    __Pyx_GIVEREF(__pyx_t_7);
    PyTuple_SET_ITEM(__pyx_t_67, 1, __pyx_t_4);
    __Pyx_GIVEREF(__pyx_t_4);
    PyTuple_SET_ITEM(__pyx_t_67, 2, __pyx_t_5);
    __Pyx_GIVEREF(__pyx_t_5);
    PyTuple_SET_ITEM(__pyx_t_67, 3, __pyx_t_6);
    __Pyx_GIVEREF(__pyx_t_6);
    PyTuple_SET_ITEM(__pyx_t_67, 4, __pyx_t_8);
    __Pyx_GIVEREF(__pyx_t_8);
    PyTuple_SET_ITEM(__pyx_t_67, 5, __pyx_t_65);
    __Pyx_GIVEREF(__pyx_t_65);
    PyTuple_SET_ITEM(__pyx_t_67, 6, __pyx_t_66);
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_67 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_67)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_67);
    __pyx_t_66 = __Pyx_PyObject_GetAttrStr(__pyx_t_67, __pyx_n_s_asarray); if (unlikely(!__pyx_t_66)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_66);
    __Pyx_DECREF(__pyx_t_67); __pyx_t_67 = 0;
    __pyx_t_67 = __pyx_memoryview_fromslice(__pyx_v_w_bar, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_67)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_67);
    __pyx_t_65 = PyTuple_New(1); if (unlikely(!__pyx_t_65)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_65);
    PyTuple_SET_ITEM(__pyx_t_65, 0, __pyx_t_67);
    __Pyx_GIVEREF(__pyx_t_67);
    __pyx_t_67 = 0;
    __pyx_t_67 = __Pyx_PyObject_Call(__pyx_t_66, __pyx_t_65, NULL); if (unlikely(!__pyx_t_67)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_67);
    __Pyx_DECREF(__pyx_t_66); __pyx_t_66 = 0;
    __Pyx_DECREF(__pyx_t_65); __pyx_t_65 = 0;
    __pyx_t_65 = __pyx_convert_vector_to_py_double(__pyx_v_train_res); if (unlikely(!__pyx_t_65)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_65);
    __pyx_t_66 = __pyx_convert_vector_to_py_double(__pyx_v_test_res); if (unlikely(!__pyx_t_66)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_66);
    __pyx_t_8 = __pyx_convert_vector_to_py_double(__pyx_v_num_zs); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_6 = __pyx_convert_vector_to_py_double(__pyx_v_num_iters); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_5 = __pyx_convert_vector_to_py_double(__pyx_v_num_features); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_4 = __pyx_convert_vector_to_py_double(__pyx_v_sqnorm_w); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_7 = __pyx_convert_vector_to_py_double(__pyx_v_timecost); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_68 = PyTuple_New(8); if (unlikely(!__pyx_t_68)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_68);
    PyTuple_SET_ITEM(__pyx_t_68, 0, __pyx_t_67);
    __Pyx_GIVEREF(__pyx_t_67);
    PyTuple_SET_ITEM(__pyx_t_68, 1, __pyx_t_65);
    __Pyx_GIVEREF(__pyx_t_65);
    PyTuple_SET_ITEM(__pyx_t_68, 2, __pyx_t_66);
    __Pyx_GIVEREF(__pyx_t_66);
    PyTuple_SET_ITEM(__pyx_t_68, 3, __pyx_t_8);
    __Pyx_GIVEREF(__pyx_t_8);
    PyTuple_SET_ITEM(__pyx_t_68, 4, __pyx_t_6);
    __Pyx_GIVEREF(__pyx_t_6);
    PyTuple_SET_ITEM(__pyx_t_68, 5, __pyx_t_5);
    __Pyx_GIVEREF(__pyx_t_5);
    PyTuple_SET_ITEM(__pyx_t_68, 6, __pyx_t_4);
    __Pyx_GIVEREF(__pyx_t_4);
    PyTuple_SET_ITEM(__pyx_t_68, 7, __pyx_t_7);
    __Pyx_GIVEREF(__pyx_t_7);
    __pyx_t_67 = 0;
    __pyx_t_65 = 0;
    __pyx_t_66 = 0;
...
/* "online_lasso/scg_lasso.pyx":163
 * @cython.cdivision(True)
 * @cython.wraparound(False)
...
static CYTHON_INLINE PyObject *__pyx_f_12online_lasso_9scg_lasso_sign_func(double __pyx_v_x) {
  ...
  /* "online_lasso/scg_lasso.pyx":164
 * @cython.wraparound(False)
 * cdef inline sign_func(double x):
 *     if x > 0:             # <<<<<<<<<<<<<<
 *         return 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "online_lasso/scg_lasso.pyx":165
 * cdef inline sign_func(double x):
 *     if x > 0:
 *         return 1             # <<<<<<<<<<<<<<
 *     elif x<0:
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":166
 *     if x > 0:
 *         return 1
 *     elif x<0:             # <<<<<<<<<<<<<<
 *         return -1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "online_lasso/scg_lasso.pyx":167
 *         return 1
 *     elif x<0:
 *         return -1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_12online_lasso_9scg_lasso_sign_func(__pyx_v_b); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_1 = PyFloat_FromDouble(fmax((fabs(__pyx_v_b) - __pyx_v_c), 0.0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Multiply(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_a); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
...
static PyObject *__pyx_f_12online_lasso_9scg_lasso_eval_lasso_obj(__Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, double __pyx_v_lmda) {
  ...
  /* "online_lasso/scg_lasso.pyx":187
 *     evaluate objective 0.5/n* ||Y-Xw||^2 + lmda * |w|
 *     """
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":188
 *     """
 *     cdef Py_ssize_t n = x.shape[0]
 *     cdef Py_ssize_t p = x.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double [::1] z = np.zeros(n)
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":189
 *     cdef Py_ssize_t n = x.shape[0]
 *     cdef Py_ssize_t p = x.shape[1]
 *     cdef double [::1] z = np.zeros(n)             # <<<<<<<<<<<<<<
 *     mat_vec(x, w, z)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (unlikely(!__pyx_t_4.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_z = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "online_lasso/scg_lasso.pyx":190
 *     cdef Py_ssize_t p = x.shape[1]
 *     cdef double [::1] z = np.zeros(n)
 *     mat_vec(x, w, z)             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i
 *     cdef double res = 0
 */
  __pyx_t_1 = __pyx_f_12online_lasso_9scg_lasso_mat_vec(__pyx_v_x, __pyx_v_w, __pyx_v_z); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "online_lasso/scg_lasso.pyx":192
 *     mat_vec(x, w, z)
 *     cdef Py_ssize_t i
 *     cdef double res = 0             # <<<<<<<<<<<<<<
 *     for i in xrange(n):
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":193
 *     cdef Py_ssize_t i
 *     cdef double res = 0
 *     for i in xrange(n):             # <<<<<<<<<<<<<<
 *         res += (y[i]-z[i])**2
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    ...
    /* "online_lasso/scg_lasso.pyx":194
 *     cdef double res = 0
 *     for i in xrange(n):
 *         res += (y[i]-z[i])**2             # <<<<<<<<<<<<<<
 *     res *= 0.5 / n
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":195
 *     for i in xrange(n):
 *         res += (y[i]-z[i])**2
 *     res *= 0.5 / n             # <<<<<<<<<<<<<<
 *     for i in xrange(p):
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":196
 *         res += (y[i]-z[i])**2
 *     res *= 0.5 / n
 *     for i in xrange(p):             # <<<<<<<<<<<<<<
 *         res += lmda * fabs(w[i])
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_res); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 198; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "online_lasso/scg_lasso.pyx":204
 * @cython.cdivision(True)
 * @cython.wraparound(False)
...
static PyObject *__pyx_f_12online_lasso_9scg_lasso_mat_vec(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_c) {
  ...
  /* "online_lasso/scg_lasso.pyx":212
 *     :return:c
 *     """
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":213
 *     """
 *     cdef Py_ssize_t n = A.shape[0]
 *     cdef Py_ssize_t m = A.shape[1]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i, j
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":215
 *     cdef Py_ssize_t m = A.shape[1]
 *     cdef Py_ssize_t i, j
 *     for i in xrange(n):             # <<<<<<<<<<<<<<
 *         c[i] = 0
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "online_lasso/scg_lasso.pyx":216
 *     cdef Py_ssize_t i, j
 *     for i in xrange(n):
 *         c[i] = 0             # <<<<<<<<<<<<<<
 *         for j in xrange(m):
 ...
 */
    ...
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_c.data) + __pyx_t_3)) )) = 0.0;
    ...
    /* "online_lasso/scg_lasso.pyx":217
 *     for i in xrange(n):
 *         c[i] = 0
 *         for j in xrange(m):             # <<<<<<<<<<<<<<
 *             c[i] += A[i,j] * b[j]
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_10 = __pyx_memoryview_fromslice(__pyx_v_c, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "online_lasso/scg_lasso.pyx":230
...
static int __pyx_pw_12online_lasso_9scg_lasso_9RandNoRep_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_n = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 230; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static int __pyx_pf_12online_lasso_9scg_lasso_9RandNoRep___init__(struct __pyx_obj_12online_lasso_9scg_lasso_RandNoRep *__pyx_v_self, int __pyx_v_n) {
  ...
  /* "online_lasso/scg_lasso.pyx":231
 * 
 *     def __init__(self, int n):
 *         self.seeds = np.zeros(n, dtype=np.intp)             # <<<<<<<<<<<<<<
 *         self.n = n
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 231; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_intp); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 231; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 231; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 231; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":234
 *         self.n = n
 *         cdef Py_ssize_t i
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             self.seeds[i] = i
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "online_lasso/scg_lasso.pyx":235
 *         cdef Py_ssize_t i
 *         for i in range(n):
 *             self.seeds[i] = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    if (unlikely(!__pyx_v_self->seeds.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 235; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = -1;
    if (__pyx_t_9 < 0) {
...
/* "online_lasso/scg_lasso.pyx":237
 *             self.seeds[i] = i
 * 
 *     cdef k_choice(self, Py_ssize_t [::1] arr, Py_ssize_t k):             # <<<<<<<<<<<<<<
 *         """
 ...
 */
  ...
  /* "online_lasso/scg_lasso.pyx":242
 *         """
 *         assert (k <= self.n-1)
 *         assert (k <=arr.size)             # <<<<<<<<<<<<<<
 *         cdef Py_ssize_t pt = self.n-1
 ...
 */
  #ifndef CYTHON_WITHOUT_ASSERTIONS
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_k); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 242; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_arr, 1, (PyObject *(*)(char *)) __pyx_memview_get_Py_ssize_t, (int (*)(char *, PyObject *)) __pyx_memview_set_Py_ssize_t, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 242; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_size); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 242; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyObject_RichCompare(__pyx_t_1, __pyx_t_3, Py_LE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 242; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *             self.seeds[j] = tmp
 */
    if (unlikely(!__pyx_v_self->seeds.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 247; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    ...
    /* "online_lasso/scg_lasso.pyx":248
 *             j = rand() % self.n
 *             tmp = self.seeds[pt]
 *             self.seeds[pt] = self.seeds[j]             # <<<<<<<<<<<<<<
 *             self.seeds[j] = tmp
 *             arr[i] = self.seeds[pt]
 */
    if (unlikely(!__pyx_v_self->seeds.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 248; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_9 = __pyx_v_j;
    __pyx_t_7 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_self->seeds.shape[0];
    ...
    *((Py_ssize_t *) ( /* dim=0 */ ((char *) (((Py_ssize_t *) __pyx_v_self->seeds.data) + __pyx_t_10)) )) = (*((Py_ssize_t *) ( /* dim=0 */ ((char *) (((Py_ssize_t *) __pyx_v_self->seeds.data) + __pyx_t_9)) )));
    ...
    /* "online_lasso/scg_lasso.pyx":249
 *             tmp = self.seeds[pt]
 *             self.seeds[pt] = self.seeds[j]
 *             self.seeds[j] = tmp             # <<<<<<<<<<<<<<
 *             arr[i] = self.seeds[pt]
 *             pt -= 1
 */
    if (unlikely(!__pyx_v_self->seeds.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 249; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 *             pt -= 1
 */
    if (unlikely(!__pyx_v_self->seeds.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 250; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    ...
    *((Py_ssize_t *) ( /* dim=0 */ ((char *) (((Py_ssize_t *) __pyx_v_arr.data) + __pyx_t_13)) )) = (*((Py_ssize_t *) ( /* dim=0 */ ((char *) (((Py_ssize_t *) __pyx_v_self->seeds.data) + __pyx_t_12)) )));
    ...
    /* "online_lasso/scg_lasso.pyx":251
 *             self.seeds[j] = tmp
 *             arr[i] = self.seeds[pt]
 *             pt -= 1             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_sqnorm_w, __pyx_k_sqnorm_w, sizeof(__pyx_k_sqnorm_w), 0, 0, 1, 1},
 ...
 *     """
 */
  __pyx_tuple__20 = PyTuple_Pack(48, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_xtest, __pyx_n_s_ytest, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_lmda, __pyx_n_s_sig_D, __pyx_n_s_verbosity, __pyx_n_s_T, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_t, __pyx_n_s_n, __pyx_n_s_p, __pyx_n_s_I, __pyx_n_s_J, __pyx_n_s_u, __pyx_n_s_l, __pyx_n_s_flag, __pyx_n_s_has_test, __pyx_n_s_w_tilde, __pyx_n_s_w, __pyx_n_s_w_bar, __pyx_n_s_cur_grad, __pyx_n_s_g_tilde, __pyx_n_s_ind, __pyx_n_s_sig, __pyx_n_s_D, __pyx_n_s_gm, __pyx_n_s_num_iters, __pyx_n_s_num_features, __pyx_n_s_train_res, __pyx_n_s_test_res, __pyx_n_s_num_zs, __pyx_n_s_sqnorm_w, __pyx_n_s_timecost, __pyx_n_s_num_steps, __pyx_n_s_interval, __pyx_n_s_count, __pyx_n_s_start_t, __pyx_n_s_end_t, __pyx_n_s_cpu_t, __pyx_n_s_tmp, __pyx_n_s_tmp2, __pyx_n_s_xw, __pyx_n_s_r1, __pyx_n_s_r2); if (unlikely(!__pyx_tuple__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(10, 0, 48, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_qdengpercy_workspace_dual, __pyx_n_s_train, 54, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  if (PyType_Ready(&__pyx_type_12online_lasso_9scg_lasso_RandNoRep) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 222; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_12online_lasso_9scg_lasso_RandNoRep.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_12online_lasso_9scg_lasso_RandNoRep.tp_dict, __pyx_vtabptr_12online_lasso_9scg_lasso_RandNoRep) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 222; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "RandNoRep", (PyObject *)&__pyx_type_12online_lasso_9scg_lasso_RandNoRep) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 222; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (unlikely(!__pyx_t_3.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_k__2 = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12online_lasso_9scg_lasso_1train, NULL, __pyx_n_s_online_lasso_scg_lasso); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_train, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
